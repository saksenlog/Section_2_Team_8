...
<a href="Logout.jsp">Log out</a>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="details"><label>Hospital ID</label><span class="colon">:</span><span id="donorid">${detailsh.hid}</span></div>
      <div class="details">Hospital Name<label></label><span class="colon">:</span><span id="donorname">${detailsh.hospitalName}</span></div>
